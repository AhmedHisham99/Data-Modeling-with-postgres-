...
user_id int NOT NULL,level varchar NOT NULL,song_id varchar,\
artist_id varchar,session_id int NOT NULL, location varchar NOT NULL,\
user_agent varchar NOT NULL);")

user_table_create = ("CREATE TABLE IF NOT EXISTS users\
(user_id int PRIMARY KEY, firstname varchar NOT NULL,\
lastname varchar NOT NULL,gender char(1) NOT NULL,\
level varchar NOT NULL);")

song_table_create = ("""CREATE TABLE IF NOT EXISTS songs\
(song_id varchar PRIMARY KEY, title varchar NOT NULL,\
artist_id varchar NOT NULL,year int NOT NULL,\
duration numeric NOT NULL);""")

artist_table_create = ("CREATE TABLE IF NOT EXISTS artists\
(artist_id varchar PRIMARY KEY, name varchar NOT NULL,\
location varchar NOT NULL,latitude double precision NOT NULL,\
...
user_table_insert = ("INSERT INTO users(user_id, firstname,\
lastname, gender, level) VALUES(%s, %s, %s, %s, %s) ON CONFLICT\
(user_id) DO UPDATE SET level = EXCLUDED.level;")

song_table_insert = ("INSERT INTO songs(song_id, title, artist_id,\
year, duration) VALUES(%s,%s,%s,%s,%s)ON CONFLICT DO NOTHING")
...
month, year, weekday) VALUES(%s,%s,%s,%s,%s,%s,%s)ON CONFLICT DO NOTHING")

# FIND SONGS

song_select = ("SELECT songs.artist_id,artists.artist_id FROM songs \
